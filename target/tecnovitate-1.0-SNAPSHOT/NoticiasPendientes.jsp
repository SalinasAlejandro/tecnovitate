                ...
                <div class="row row-cols-1 row-cols-md-3">
                    ...
                    <div class="col mb-4">
                        <div class="card h-100">
                            <a href="NoticiaPendientController?id=<%= not.getId()%>">
                                <img src="<%= not.getPath1()%>" class="card-img-top">
                                <div class="card-body">
                                    <h5 class="card-title"><%= not.getTitulo()%></h5>
                                    <p class="card-text"><%= not.getDescrip()%></p>
                                    <p class="card-text"><small class="text-muted"><%= not.getUser().getNombre_Usua()%> </small><small class="text-muted"><%= not.getFecha()%></small></p>

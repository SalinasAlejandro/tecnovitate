 ...
 * @author dykeo
 */
@WebServlet(name = "NoticiaCanceladoControlle", urlPatterns = {"/NoticiaCanceladoControlle"})
@MultipartConfig(maxFileSize = 1024 * 1024 * 5, maxRequestSize = 1024 * 1024 * 25)
public class NoticiaCanceladoControlle extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       request.getRequestDispatcher("NoticiaCancelado.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String IdUsua = request.getParameter("IdUsua");
        ...
        Noticias nuevaNot = new Noticias(Integer.parseInt(idNoti), title, descripcion, noticia, new Categorias(idCategory),
                FileUtils.RUTE_USER_IMAGE + "/" + nameImage, FileUtils.RUTE_USER_IMAGE + "/" + nameImage2,
                FileUtils.RUTE_USER_IMAGE + "/" + nameImage3, nameImagev);
        NoticiasDAO.modifNoti(nuevaNot);

        response.sendRedirect("NoticiaCancelados?idCreador=" + IdUsua);
    }

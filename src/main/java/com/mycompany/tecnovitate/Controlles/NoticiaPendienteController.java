 ...
 * @author dykeo
 */
@WebServlet(name = "NoticiaPendienteController", urlPatterns = {"/NoticiaPendienteController"})
public class NoticiaPendienteController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        List<Noticias> noti = NoticiasDAO.getNewsPendientes();

 ...
 * @author dykeo
 */
@WebServlet(name = "NoticiaPendientController", urlPatterns = {"/NoticiaPendientController"})
public class NoticiaPendientController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       request.getRequestDispatcher("NoticiaPendiente.jsp").forward(request, response);
    }

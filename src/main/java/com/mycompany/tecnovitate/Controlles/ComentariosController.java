...
public class ComentariosController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(idUser == ""){
            ComentariosDAO.insertCommentary(new Comentarios(null, content, Integer.parseInt(idNews)));
        }else{
            Usuario user = UsuarioDAO.IniSesion(Integer.parseInt(idUser));
            ComentariosDAO.insertCommentary(new Comentarios(user, content, Integer.parseInt(idNews)));
        }

 ...
 */
package com.mycompany.tecnovitate.Utils;
...
public class DbConnection {
    ...
    static {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/tecnovitate?useUnicode=true&useJDBCCompliantTimeZoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC");
